...
export async function generateMetadata({
  ...
  return {
    ...
    description: form.description || "Submit your information to Checkmate Property.",
  };
}

export default async function DynamicFormPage({ params }: FormPageProps) {
  const { slug } = await params;
        ...
        <aside className="h-fit rounded-[32px] border border-[rgba(12,41,51,0.08)] bg-white p-6 shadow-[0_18px_50px_rgba(12,41,51,0.06)]">
          ...
          <div className="mt-6 rounded-2xl border border-[#53bc76]/18 bg-[#53bc76]/8 p-4">
            ...
            <p className="mt-2 text-sm leading-6 text-[#64748b]">
              This form can trigger custom webhooks, save submissions and redirect
              users to a specific thank you page.
            </p>
          </div>
        </aside>
