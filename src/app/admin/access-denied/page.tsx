...
export default async function AdminAccessDeniedPage() {
  ...
  return (
    <div className="flex min-h-[70vh] items-center justify-center bg-[#f8f6f1] px-5 py-10">
      <div className="admin-card max-w-lg rounded-[2rem] p-8 text-center shadow-[0_20px_60px_rgba(23,22,20,0.08)]">
        ...
        {session ? (
          <div className="mt-6 rounded-2xl bg-[#f8f6f1] p-4 text-left">
            <p className="text-xs font-bold uppercase tracking-[0.2em] text-[#587469]">
              Current role
            </p>

            <p className="mt-2 text-lg font-bold text-[#171614]">
